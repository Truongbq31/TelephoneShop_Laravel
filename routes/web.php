...
Route::match(['GET', "POST"],'/telephone/admin/products/edit/{id}',[\App\Http\Controllers\ProductsController::class,'addProducts'])->name('route_admin_editProducts');
//Categories
...
Route::match(['GET', "POST"],'/telephone/admin/categories/edit/{id}',[\App\Http\Controllers\CategoriesController::class,'addCategories'])->name('route_admin_editCategories');
//End admin
