...
<!-- Mirrored from weblearnbd.net/tphtml/shofy-prv/shofy/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jul 2023 09:22:26 GMT -->
<head>
    <meta charset="utf-8">
...
{{--                        </svg>--}}
{{--                    </div>--}}
{{--                    <img src="{{asset('client/assets/img/logo/preloader/preloader-icon.svg')}}" alt="">--}}
{{--                </div>--}}
        ...
        <div class="offcanvas__content">
            <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                <div class="offcanvas__logo logo">
                    <a href="{{route('route_client_index')}}">
                ...
                <div class="offcanvas__select language">
                    <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                        <div class="offcanvas__lang-img mr-15">
                            <img src="{{asset('client/assets/img/icon/language-flag.png')}}" alt="">
                        </div>
        ...
        <div class="row row-cols-5">
            <div class="col">
                <div class="tp-mobile-item text-center">
                    <a href="{{route('route_client_products')}}" class="tp-mobile-item-btn">
...
{{--            </div>--}}
            ...
            <div class="cartmini__empty text-center d-none">
                <img src="{{asset('client/assets/img/product/cartmini/empty-cart.png')}}" alt="">
                ...
                <div class="row align-items-center">
                            ...
                            <form action="#">
                                ...
                                <div class="tp-header-search-wrapper d-flex align-items-center">
                                    <div class="tp-header-search-box">
                                        <input name="search_prds" type="text" placeholder="Search for Products...">
                                    </div>
                                    <div class="tp-header-search-category">
                                        <select>
                                            <option disabled selected>Select Catgories</option>
                                            @php $categories = \App\Models\Admin\Categories::all(); @endphp
                    ...
                    <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                            <a <?php echo \Illuminate\Support\Facades\Auth::user() == false ? "hidden" : "" ?> href="{{route('route_client_profile')}}">
                            ...
                            <a <?php echo \Illuminate\Support\Facades\Auth::user() == true ? "hidden" : "" ?> href="{{route('route_client_login')}}">
                                <div class="tp-header-login-icon">
                                <span>
                                   <svg width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <circle cx="8.57894" cy="5.77803" r="4.77803" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="tp-header-login d-none d-lg-block">
                                <a href="#" class="d-flex align-items-center">
                                    <div class="tp-header-login-content d-none d-xl-block mt-2">
                                        <span <?php echo \Illuminate\Support\Facades\Auth::user() == false ? "hidden" : "" ?>>Hello, <?php echo \Illuminate\Support\Facades\Auth::user() == true ? \Illuminate\Support\Facades\Auth::user()->name : ""?></span>
                                    </div>
                                </a>
                                <div class="tp-header-login-content d-none d-xl-block mt-2">
                                    <a <?php echo \Illuminate\Support\Facades\Auth::user() == true ? "hidden" : "" ?> class="tp-header-login-title" href="{{route('route_client_login')}}">Sign In</a>
                                    <a <?php echo \Illuminate\Support\Facades\Auth::user() == false ? "hidden" : "" ?> class="tp-header-login-title" href="{{route('route_client_logout')}}">Log Out</a>
                            ...
                            <div class="tp-header-action d-flex align-items-center ml-50">
                                @if(\Illuminate\Support\Facades\Auth::user()->id)
                                    <div class="tp-header-action-item d-none d-lg-block">
                                        <a href="{{route('route_client_oderdetail')}}"  class="tp-header-action-btn">
                                         ...
                                         <span>
                                            ...
                                            <ul class="mega-menu tp-submenu">
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img src="{{asset('client/assets/img/header/menu/menu-1.jpg')}}" alt=""></a>
                                                        </li>
                                                        <li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img src="{{asset('client/assets/img/header/menu/menu-2.jpg')}}" alt=""></a>
                                                        </li>
                                                        <li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img src="{{asset('client/assets/img/header/menu/menu-3.jpg')}}" alt=""></a>
                                                        </li>
                                                        <li>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="main-menu menu-style-1">
                                <nav class="tp-main-menu-content">
                                    <ul>
                                        <li><a href="{{route('route_client_index')}}">Home</a></li>

                                        <li><a href="{{route('route_client_products')}}">Shop</a></li>

                                        <li class="has-dropdown">
                                            <a href="#">Products</a>
                                            <ul class="tp-submenu">
                                                @foreach($categories as $ctg)
                                                <li><a href="{{route('route_client_prdByCategoriesName',['name'=>$ctg->name])}}">{{$ctg->name}}</a></li>
                                                @endforeach
                                            </ul>
                                        </li>
