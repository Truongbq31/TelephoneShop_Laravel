...
<!-- Mirrored from weblearnbd.net/tphtml/shofy-prv/shofy/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jul 2023 09:23:41 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            <h3 class="tp-login-title">Login to Website.</h3>
                            <p>Don’t have an account? <span><a href="{{route('route_client_register')}}">Create a free account</a></span></p>
                        </div>
                        <form method="POST" action="{{route('route_client_login')}}">
                            @csrf
...
<!-- Mirrored from weblearnbd.net/tphtml/shofy-prv/shofy/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jul 2023 09:23:45 GMT -->
</html>
