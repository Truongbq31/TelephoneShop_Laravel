...
{{--        @foreach($banners as $bn)--}}
{{--        <div class="carousel-item active">--}}
{{--            <img src="{{''.\Illuminate\Support\Facades\Storage::url($bn->image)}}" class="d-block h-100 w-100" alt="...">--}}
{{--        </div>--}}
{{--        @endforeach--}}
{{--        <div class="carousel-item">--}}
{{--            <img src="assets/img/slider/slider-img-2.png" class="d-block h-100 w-100" alt="...">--}}
{{--        </div>--}}
{{--        <div class="carousel-item">--}}
{{--            <img src="assets/img/slider/slider-img-3.png" class="d-block h-100 w-100" alt="...">--}}
{{--        </div>--}}
{{--    </div>--}}
