...
@section('content')
    <main>
        ...
        @foreach($productsDetail as $prdD)
                        ...
                        <div class="breadcrumb__content p-relative z-index-1">
                           ...
                           <span class="breadcrumb-icon">
                              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span><a href="#">{{$prdD->cate_name}}</a></span>
                                <span>{{$prdD->name}}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <nav>
                                    <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                        <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                            <img src="{{''.\Illuminate\Support\Facades\Storage::url($prdD->image)}}" alt="">
                                        </button>
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                <div class="tp-product-details-category">
                                    <span>{{$prdD->cate_name}}</span>
                                </div>
                                <h3 class="tp-product-details-title">{{$prdD->name}}</h3>

                                <!-- inventory details -->
                                <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                    <div class="tp-product-details-stock mb-10">
                                        <span>{{$prdD->status == 1 ? 'Stock' : 'Out Of Stock'}}</span>
                                    </div>
...
{{--                                    <span class="tp-product-details-price old-price">$320.00</span>--}}
                                    <span class="tp-product-details-price new-price">${{$prdD->price}}</span>
                                </div>
