                        ...
                        <div class="breadcrumb__content p-relative z-index-1">
                           ...
                           <span class="breadcrumb-icon">
                              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span><a href="{{route('route_client_products')}}">Shop</a></span>
                                <span>{{$prd->name}}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{''.\Illuminate\Support\Facades\Storage::url($prd->image)}}" class="d-block w-100" alt="...">
                                    </div>
                                    @foreach($imgsPrd as $img)
                                    <div class="carousel-item">
                                        <img src="{{''.\Illuminate\Support\Facades\Storage::url($img->images)}}" class="d-block w-100" alt="...">
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                <div class="tp-product-details-category">
                                    <span>Brand: {{$prd->cate_name}}</span>
                                </div>
                                <h3 class="tp-product-details-title">{{$prd->name}}</h3>
                                ...
                                <p>{{$prd->description}}<span> See more</span></p>

                                <!-- price -->
                                <div class="tp-product-details-price-wrapper mb-20">
{{--                                    <span class="tp-product-details-price old-price">$320.00</span>--}}
                                    <span class="tp-product-details-price new-price">${{$prd->price}}</span>
                                </div>
                            ...
                            <div class="tp-product-details-tab-nav tp-tab">
                                <nav>
                                    <div class="nav nav-tabs justify-content-center p-relative tp-product-tab" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="true">Reviews</button>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="tp-product-details-desc-content pt-25">
                                                                    <span>{{$prd->name}}</span>
                                                                    <h3 class="tp-product-details-desc-title">Products Information</h3>
                                                                    <p>{{$prd->description}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
...
{{--                                                    </div>--}}
                                    ...
                                    @include('client.comment.view_comment')
        ...
        <section class="tp-related-product pt-95 pb-120">
            <div class="container">
                ...
                <div class="row">
                    @foreach($prdByCate as $prdCate)
                        @if($prdCate->cate_name == $prd->cate_name)
                            <div <?php echo $prdCate->id == $prd->id ? "hidden" : "";?> class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="tp-product-item-2 mb-40">
                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                        <a href="{{route('route_client_productsDetail',['id'=>$prdCate->id])}}">
                                            <img width="100%" height="300px" src="{{''.\Illuminate\Support\Facades\Storage::url($prdCate->image)}}" alt="imgPrd">
                                        </a>
                                        <!-- product action -->
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                        <div class="tp-product-tag-2">
                                            <a href="#">{{$prdCate->cate_name}}</a>
                                        </div>
                                        <h3 class="tp-product-title-2">
                                            <a href="{{route('route_client_productsDetail',['id'=>$prdCate->id])}}">{{$prdCate->name}}</a>
                                        </h3>
                                        ...
                                        <div class="tp-product-price-wrapper-2">
                                            <span class="tp-product-price-2 new-price">${{$prdCate->price}}</span>
