                                                        ...
                                                        <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                            ...
                                                            <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                                <div class="tp-product-action-item-2 d-flex flex-column">
                                                                    <button onclick="window.location.href='{{route('route_cart_add',['id'=>$prd->id])}}'" type="button" class="tp-product-action-btn-2 tp-product-add-cart-btn">
                                                                    ...
                                                                    <button onclick="window.location.href='{{route('route_client_productsDetail',['id'=>$prd->id])}}'" type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                                                        ...
                                                                        <span class="tp-product-tooltip tp-product-tooltip-right">Detail</span>
                                                                    </button>
...
{{--                                        <button onclick="window.location.href='{{route('route_cart_add',['id'=>$prd->id])}}'" class="tp-product-details-add-to-cart-btn w-100">Add To Cart</button>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
