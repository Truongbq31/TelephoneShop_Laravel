            ...
            <div class="container">
                ...
                <div class="profile__inner p-relative">
                    <div class="profile__shape">
                        <img class="profile__shape-1" src="{{asset('client/assets/img/login/laptop.png')}}" alt="" >
                        <img class="profile__shape-2" src="{{asset('client/assets/img/login/man.png')}}" alt="" >
                        <img class="profile__shape-3" src="{{asset('client/assets/img/login/shape-1.png')}}" alt="" >
                        <img class="profile__shape-4" src="{{asset('client/assets/img/login/shape-2.png')}}" alt="" >
                        <img class="profile__shape-5" src="{{asset('client/assets/img/login/shape-3.png')}}" alt="" >
                        <img class="profile__shape-6" src="{{asset('client/assets/img/login/shape-4.png')}}" alt="" >
                    </div>
                    <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                            <div class="profile__main-thumb">
                                                                <img src="{{asset('client/assets/img/login/user.png')}}" alt="">
...
{{--                                                                </div>--}}
                                                            ...
                                                            <div class="profile__main-content">
                                                                <h4 class="profile__main-title">Welcome {{\Illuminate\Support\Facades\Auth::user()->name}}</h4>
{{--                                                                <p>You have <span>08</span> notifications</p>--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="profile__main-logout text-sm-end">
                                                            <a href="{{route('route_client_logout')}}" class="tp-logout-btn">Logout</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
{{--                                                   <span class="profile-icon-count profile-wishlist">07</span>--}}
                                    ...
                                    <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                                        <div class="profile__info">
                                            ...
                                            <div class="profile__info-content">
                                                <form action="{{route('route_client_updateProfile', ['id'=>\Illuminate\Support\Facades\Auth::user()->id])}}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <input name="name" type="text" placeholder="Enter your username" value="{{\Illuminate\Support\Facades\Auth::user()->name}}">
                                                                    <span>
                                                      <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <input name="email" type="email" placeholder="Enter your email" value="{{\Illuminate\Support\Facades\Auth::user()->email}}">
                                                                    <span>
                                    ...
                                    <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                                        <div class="profile__password">
                                            <form method="POST" action="{{route('route_client_changePassword', ['id'=>\Illuminate\Support\Facades\Auth::user()->id])}}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-xxl-6 col-md-6">
