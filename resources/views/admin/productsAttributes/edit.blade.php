                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data" class="theme-form theme-form-2 mega-form">
                                        @csrf
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <select class="js-example-basic-single w-100" name="products_id">
                                                @foreach($products as $value)
                                                    <option value="{{$value->id}}"  {{$value->name==$productsAttributes->name?'selected':''}}>{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <select class="js-example-basic-single w-100" name="attributes_id">
                                                @foreach($attributes  as $value)
                                                    <option value="{{$value->id}}" {{$value->value==$productsAttributes->value?'selected':''}}>{{$value->value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
